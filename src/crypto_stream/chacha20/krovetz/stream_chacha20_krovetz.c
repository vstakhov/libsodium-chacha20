...
int crypto_stream_chacha20_xor (unsigned char *out, const unsigned char *in,
...
/* Assumes all pointers are aligned properly for vector reads */
{
	...
	__attribute__ ((aligned (16))) unsigned chacha_const[] = { 0x61707865,
...
int crypto_stream_chacha20 (unsigned char *out, unsigned long long outlen,
		const unsigned char *n, const unsigned char *k)
{
	memset (out, 0, outlen);
	return crypto_stream_chacha20_xor (out, out, outlen, n, k);
}
